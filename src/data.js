...
export const projects = [
    ...
    {
      id:3,
      title: 'Food Odering App Using React js and Redux',
      image: 'https://s3-alpha.figma.com/hub/file/5101537097/c4a1ed2c-4ab9-43fb-a248-d7ac6b0c3161-cover.png',
      category:"Web",
      data:{
        description: ` 
• User Interface: Designed and implemented a responsive user interface using React js and Bootstrap to ensure a consistent
look and feel across devices.
• Optimized performance by implementing lazy loading for images and code splitting for better load times..`,
        demoLink: "https://www.linkedin.com/posts/uttam-kumar-23243823b_computerengineering-coding-viral-activity-7220246046038183936-AUXx?utm_source=share&utm_medium=member_android",
      },
      stack:[
        {
          name:"ReactJs",
...
export const socialHandles = [
  ...
  },
  {
    name:"LinkedIn",
    icon:<AiFillLinkedin/>,
    link:"https://www.linkedin.com/in/uttam-kumar-23243823b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },
  {
    name:"Youtube",
    icon:<AiFillYoutube/>,
